...
from config.config import INDEX_PATH,MISTRAL_API_KEY,MODEL_NAME,EMBEDDING_MODEL,TEST_QUESTION_PATH,TESTSET_PATH
import json
from config.logger import logger
def build_testset():

    rag = SimpleRetriever(INDEX_PATH,api_key=MISTRAL_API_KEY,embedding_model=EMBEDDING_MODEL,model_name=MODEL_NAME)
    rag.indexer.load()
